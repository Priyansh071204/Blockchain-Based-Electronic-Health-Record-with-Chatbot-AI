...
(async () => {
  ...
  store.set('RECORD_REC001', {
    ...
    metadata: { tags: ['Hematology', 'Routine'], ipfsUrl: 'http://localhost:8080/ipfs/QmXoypizjW3WknFiJnKLwHCnL72vedxjQkDDP1mXWo6uco' },
  ...
  store.set('RECORD_REC002', {
    ...
    ipfsHash: 'QmfXyz1111111111111111111111111111111111111112',
    metadata: { tags: ['Allergy', 'Medication'], ipfsUrl: 'http://localhost:8080/ipfs/QmfXyz1111111111111111111111111111111111111112' },
  ...
  store.set('RECORD_REC003', {
    ...
    ipfsHash: 'QmfXyz1111111111111111111111111111111111111113',
    metadata: { tags: ['Imaging', 'Diagnostics'], ipfsUrl: 'http://localhost:8080/ipfs/QmfXyz1111111111111111111111111111111111111113' },
  ...
  store.set('RECORD_REC004', {
    ...
    ipfsHash: 'QmfXyz1111111111111111111111111111111111111114',
    metadata: { tags: ['Cardiology', 'Prevention'], ipfsUrl: 'http://localhost:8080/ipfs/QmfXyz1111111111111111111111111111111111111114' },
